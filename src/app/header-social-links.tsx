...
function VkIcon() {
  return (
    <svg
      ...
      aria-hidden="true"
      className={`${ICON_BASE_CLASS} h-[14px] w-[14px]`}
    >
...
function DiscordIcon() {
  return (
    <svg
      ...
      preserveAspectRatio="xMidYMid meet"
      aria-hidden="true"
      className={`${ICON_BASE_CLASS} h-[14.5px] w-[14.5px]`}
    >
...
export function HeaderSocialLinks({
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="flex items-center gap-2 rounded-[18px] border border-[#3a2329] bg-[#120d10] px-3.5 py-2 shadow-[0_0_24px_rgba(255,183,197,0.08)]">
        {SOCIAL_LINKS.map((link) => {
          const commonClassName =
            "inline-flex h-6.5 w-6.5 shrink-0 items-center justify-center rounded-md align-middle text-[#ffb7c5] transition duration-200";
